  ...
  return (
    <div className="border-2 rounded-lg mx-2 sm:mx-4 md:mx-6 lg:mx-8 my-4 p-2">
      ...
      <Card className="border-none shadow-none w-full">
        <Link href={`/blog/${flow.id}`} className="flex flex-col sm:flex-row gap-2 w-full">
          ...
          {flow.thumbnail && (
            <CardContent className="relative order-1 sm:order-2 mx-auto sm:mx-0 w-full sm:w-1/3 h-[200px] sm:h-[150px] rounded-lg bg-blue-300 p-0 overflow-hidden">
              <Image
